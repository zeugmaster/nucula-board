# Archived JLCPCB r2 release instructions

Historical instructions for the already-submitted order. The current contingency
revision is described in [manufacturing release](manufacturing-release.md).
