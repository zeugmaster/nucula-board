...
Prepared 2026-09-21 for **10 assembled prototypes**, with the confirmed
...
No order has been placed and no parts have been reserved.
...
Three body-center corrections are applied in footprint-local coordinates:
U3 (0,−3.10 mm), J2 (0,−1.75 mm), DS1 (0,+1.90 mm). These come from the physical
F.Fab outlines, excluding text, not from pad-array centers. The resulting CPL
centers are U3 (51.000,53.860), J2 (5.000,59.100), DS1 (30.000,53.050) mm.
Other populated footprints are body-centered. `assembly/placement-audit.csv`
records the uncorrected origins and offsets. `assembly/pad-coordinates.csv`
provides actual pad positions/nets to resolve any supplier model disagreement.
